...
const addCompany = (req,res) => {
    ...
    const {name,email,address,telephone,customers,centers,logo,openhour,closehour,opendays,slogan,about} = req.body;

    const company = new Company({name,email,address,telephone,customers,centers,logo,openhour,closehour,opendays,slogan,about});
    ...
    const updateCompany = async (req, res) => {
        ...
        try {
          ...
          const com = await Company.findByIdAndUpdate(CompanyId, {
            name,email,address,telephone,customers,centers,logo,openhour,closehour,opendays,slogan,about
          });
